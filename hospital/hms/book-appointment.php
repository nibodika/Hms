...
if(isset($_POST['submit']))
{
    ...
    $time = $_POST['apptime'];
    $priority = isset($_POST['priority']) ? $_POST['priority'] : 3; // Default priority 3
    $userstatus = 1;
    $docstatus = 1;

    $query = mysqli_query($con, "INSERT INTO appointment(doctorSpecialization, doctorId, userId, consultancyFees, appointmentDate, appointmentTime, priority, userStatus, doctorStatus) VALUES('$specilization', '$doctorid', '$userid', '$fees', '$appdate', '$time', '$priority', '$userstatus', '$docstatus')");
