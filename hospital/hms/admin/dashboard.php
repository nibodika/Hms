						...
						<section id="page-title">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											<span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-file-invoice fa-stack-1x fa-inverse"></i> </span>
											<h2 class="StepTitle">Payment History</h2>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Medical Reports</h2>
