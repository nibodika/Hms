                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
<?php
$sql = mysqli_query($con, "SELECT doctors.doctorName AS docname, users.fullName AS pname, appointment.* FROM appointment 
JOIN doctors ON doctors.id = appointment.doctorId 
JOIN users ON users.id = appointment.userId 
ORDER BY priority ASC, appointmentDate ASC, appointmentTime ASC");
$cnt = 1;
