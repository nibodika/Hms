...
<style>
        ...
        .side-image {
            width: 50%;
            background-image: url('admin/assets/images/patientregister.jpg'); /* Replace with the actual image path */
	...
	<div class="container">
           ...
           <div class="logo margin-top-30">
				<a href="../index.php"><h2 class="text-center"> HMS | Patient Password Recovery</h2></a>
		  </div>
