...
<head>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">
                    <!-- Logo Image -->
                    <a href="index.php">
                        <img src="assets/images/logo.jpg" alt="Logo" style="width: 100px; height: auto;">
                    </a>
  ...
  <!--  ************************* Logins ************************** -->
    ...
    <section id="services" class="key-features department">
        <div class="container">
            <div class="inner-title">
                ...
                <p>Take a look at some of our offerings</p>
            </div>
        ...
        <div id="gallery" class="gallery">    
           <div class="container">
              <div class="inner-title">
                ...
                <h2>Visual Hightlight</h2>
                <p>View Our Picture Archive</p>
            </div>
              <div class="row">
        ...
        <div class="container">
            <div class="row">
                ...
                <address>
                    ...
                    while ($row = mysqli_fetch_array($ret)) {
                    ?>
                        <p class="mb-1"><strong>Address:</strong> <?php echo $row['PageDescription']; ?></p>
                        <p class="mb-1"><strong>Phone:</strong> <?php echo $row['MobileNumber']; ?></p>
                        <p class="mb-1">
                            <strong>Email:</strong>
                            <a href="mailto:<?php echo $row['Email']; ?>" class="text-white-50 text-decoration-none"><?php echo $row['Email']; ?></a>
                        </p>
                        <p class="mb-0"><strong>Timing:</strong> <?php echo $row['OpenningTime']; ?></p>
                    <?php } ?>
                </address>
            </div>
            </div>
    ...
    <div class="copy">
            ...
            &copy;Copyright 2024, Hospital Management System
                </div>
